...
const OurBreads = () => {
  ...
  return (
    <section id='breads' className='w-full flex-col items-center justify-center gap-10 bg-cover h-fit py-20 lg:px-20 px-10 bg-center' style={{ backgroundImage: `url('/banner4.jpg')` }}>
      ...
      <div data-aos="zoom-in" data-aos-delay="200" className='w-full grid lg:grid-cols-4 grid-cols-1 justify-center items-center gap-6'>
        {ourbreads.map((item, index) => (
          <div key={index} className='flex flex-col justify-center gap-4 bg-white p-8 rounded-lg'>
            <Image src={item.image} alt='bread image' width={300} height={400}
